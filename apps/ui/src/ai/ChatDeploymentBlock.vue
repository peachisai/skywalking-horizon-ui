...
-->
<!-- Per-service deployment graph, inline. REUSES the real Deployment view — the
     same LayerDeploymentView the Deployment tab renders — in its embedded
     (read-only) mode, seeded with the resolved serviceId + the chat window. No
     bespoke graph: one renderer across the product, so the instance hexes, ring
